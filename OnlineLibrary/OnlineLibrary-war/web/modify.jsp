	...
	<script>
		...
		//添加一行
		 function addNewLine(){
			...
			tar+="<button id=\"tianjia" +a+"\"   class=\"tianjia\" type=\"button\" onclick=\"addNewLine()\">+</button>";
			tar+="<button id=\"shanchu"+a+"\"   class=\"shanchu\" type=\"button\" onclick=\"deleteNewLine()\">-</button>";
			tar += "</div>";
					...
					<div id="chart">
						<div id="input-group" class="in-group">
							...
							<input type="text" placeholder="请输入修改信息" id="searchOpac0" name="searchOpac0" class="search">
                                                        <button id="tianjia"  class="tianjia" type="button" onclick="addNewLine()">+</button>
                                                        <button id="shanchu"  class="shanchu" type="button" onclick="deleteNewLine()">-</button>
						</div>
					</div>				
